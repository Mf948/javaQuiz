...
if (i === 0) {
    ...
    choiceA.addEventListener("click", function(addEventListener){

    })
}
else if (i == 1 ){
    choiceB.innerText = question[count].choices[i]
}
else if (i == 2 ){
    choiceC.innerText = question[count].choices[i]
}
else if (i == 3 ){
    choiceD.innerText = question[count].choices[i]
