...
statement.innerText = question[cu].statement
for (var i = 0; i < question[cu].choices.length; i ++ ){
if (i === 0) {
    choiceA.innerText = question[cu].choices[i]
    choiceA.addEventListener("click", function(event){
if 
    })
}
else if (i == 1 ){
    choiceB.innerText = question[cu].choices[i]
}
else if (i == 2 ){
    choiceC.innerText = question[cu].choices[i]
}
else if (i == 3 ){
    choiceD.innerText = question[cu].choices[i]
