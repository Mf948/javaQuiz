...
statement.innerText = question[he].statement
for (var i = 0; i < question[he].choices.length; i ++ ){
if (i === 0) {
    choiceA.innerText = question[he].choices[i]
    choiceA.addEventListener("click", function(event){
if 
    })
}
else if (i == 1 ){
    choiceB.innerText = question[he].choices[i]
}
else if (i == 2 ){
    choiceC.innerText = question[he].choices[i]
}
else if (i == 3 ){
    choiceD.innerText = question[he].choices[i]
