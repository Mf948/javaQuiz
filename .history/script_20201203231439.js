...
statement.innerText = question[hello].statement
for (var i = 0; i < question[hello].choices.length; i ++ ){
if (i === 0) {
    choiceA.innerText = question[hello].choices[i]
    choiceA.addEventListener("click", function(event){
if 
    })
}
else if (i == 1 ){
    choiceB.innerText = question[hello].choices[i]
}
else if (i == 2 ){
    choiceC.innerText = question[hello].choices[i]
}
else if (i == 3 ){
    choiceD.innerText = question[hello].choices[i]
